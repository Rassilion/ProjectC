        ...
        3: [function (_dereq_, module, exports) {
            ...
            var JSHINT = (function () {
                ...
                function expression(rbp, initial) {
                    ...
                    if (state.option.singleGroups && left && left.paren && !left.exprs && !isFatArrowBody && !left.triggerFnExpr) {
                        warning("W126");
                    }
                ...
                reservevar("this", function (x) {
                    if (state.directive["use strict"] && !isMethod() && !state.option.validthis && ((funct["(statement)"] &&
